...
import com.wadhwaniai.taskify.databinding.TimerRecyclerItemBinding

class TimerAdapter(private val timeData: List<Int>) :
    RecyclerView.Adapter<TimerAdapter.TimerViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TimerViewHolder {
        val binding = TimerRecyclerItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
