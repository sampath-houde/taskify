package com.wadhwaniai.taskify.ui.mainScreen.stats
...
import com.wadhwaniai.taskify.data.models.Bar
import com.wadhwaniai.taskify.data.models.entity.TaskEntity
import com.wadhwaniai.taskify.databinding.FragmentStatsBinding
...
class StatsFragment : Fragment(R.layout.fragment_stats) {
    ...
    private fun configureBarChart(data: List<Bar>) {
        ...
        binding.barChart.apply {
            ...
            labelsSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12F, resources.displayMetrics)
            animate(barList)
    ...
    private fun configureErrorImage() {
        binding.errorLayout.errorImage.load(ContextCompat.getDrawable(requireContext(), ErrorTYpe.NO_TASKS_LAST_WEEK.image)) {
            crossfade(true)
        }
